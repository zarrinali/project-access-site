      ...
      <div className="App">
        <Router>
          <Switch>
            ...
            <Route exact path="/bootcamp"><Bootcamp /></Route>
            <Route exact path="/program"><Program /></Route>
            <Route exact path="/prebootcampcourse"><PreBootcampCourse /></Route>
            <Route exact path="/module1"><ModuleOne /></Route>
            <Route exact path="/module2"><ModuleTwo /></Route>
            <Route exact path="/module3"><ModuleThree /></Route>
