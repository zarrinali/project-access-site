      ...
      <div className={styles.Home}>
        ...
        <main>
          <section className={styles.target_uni}>
            ...
            <hr />
            <p>
              Our expertise lies in the application to so-called "top universities", i.e. selective
              universities that are characterized by high research output.
            </p>
            <div className={styles.regions}>
              ...
              <div className={`${styles.region} ${styles.middle}`}>
                ...
                <p>
                  ...
                  University, Massachusetts Institute of Technology, New York University, Princeton
                  University, Stanford University, UC Berkeley, University of Pennsylvania, Yale
                  University
                </p>
              </div>
              <div className={styles.region}>
          ...
          <section className={styles.help}>
            <div className={styles.help_container}>
              ...
              <div className={styles.left}>
                ...
                <p>
                  Work with an individual mentor currently attending one of our target universities
                  to get personalized feedback on your application.
                </p>
              </div>
              ...
              <div className={styles.left}>
                ...
                <p>
                  Take our preperation and follow-up courses, where we will help you along the way
                  to your target university: from orientation, to the selection of suitable courses,
